  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="navbar-collapse collapse">
      <ul class="nav navbar-nav">
        <li class="active"><a href="indexpro.php">Home</a></li>
        <li><a href="listadeanimaispro.php"><font color="black">Lista de Animais</font></a></li>
        <li><a href="cadastroani.php"><font color="black">Cadastrar Animais</font></a></li>
        <li><a href="calender.php"><font color="black">Consultar Agendamento</font></a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
      <form class="navbar-form" action="buscadeanimalpro.php" method="get">
      <div class="form-group">
