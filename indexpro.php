...
<html lang="pt-br">
	...
	$cod = $_SESSION['idOng'];
    $sql = mysqli_query($conexao, "SELECT * FROM animal WHERE cod_Ong = '$cod' ORDER BY nomeAni ");
            ...
            <div class="col-sm-6 col-md-4">
                ...
                <?php echo "<img src='fotos/".$usuario->fotoAni."' alt='Foto de exibição'  /><br />" ;?>
                    ...
                    <div class="caption">
                        ...
                        <strong>Descrição:</strong> <?php  echo " " . $usuario->descricaoAni  . ""; ?> <br/><br/>

                       
                       
                        <a href="deletarani.php?idAni=<?php echo $_SESSION['idAni'];?>" class="btn btn-danger">Deletar Animal</a> <br/>
